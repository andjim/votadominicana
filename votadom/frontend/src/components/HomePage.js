        ...
        return <Grid container  align="center" spacing={1}>
            <Grid container item xs={12} sx={{height: "max-content", boxShadow: "1px 0px 3px rgba(0, 0, 0, 0.6)"}}>
                ...
                <Grid item  xs={6} align="right" padding={2}>
                    <MuiLink href="/admin" underline="none" color="#0d1b3c" fontFamily="Roboto">
                        Acceso
                    </MuiLink>
                </Grid>
            </Grid>
            ...
            <Grid item xs={12}>
                ...
                <Button component={Link} to="/" variant="contained" startIcon={<HowToVoteIcon/>} size="large" color="primary" sx={{marginTop:2, fontSize:"1.6rem"}}>
                    ¡Vota Ahora!
                </Button>
            </Grid>
            <Grid item xs={12}>
